...
abstract class Listify_Listing {
	...
	public function get_secondary_image( $args = array() ) {
		$defaults = array(
			...
			'size' => 'thumbnail',
			'type' => get_theme_mod( 'listing-archive-card-avatar', 'none' ),
	...
	public function is_open() {
		...
		return (bool) apply_filters( 'listify_get_listing_is_open', $is_open, $this );
	}
		...
		return apply_filters( 'listify_get_listing_to_array', array(
			...
			'reviews' => array(
				...
				'stars' => array(
					...
					'empty' => 5 - floor( $this->get_rating_average() ) - ceil( $this->get_rating_average() - floor( $this->get_rating_average() ) ),
				),
				'i18n' => array(
