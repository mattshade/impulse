...
function listify_get_listing_card_class( $post = null ) {
	...
	// HTML default column is 2 column.
	$cols = 'col-xs-12 col-md-6';

	// Use 3 columns.
	if ( is_front_page() || 'results' === get_theme_mod( 'listing-archive-output', 'map-results' ) || is_page_template( 'page-templates/template-widgetized.php' ) ) {
		$cols = 'col-xs-12 col-md-6 col-lg-4';
	}

	$classes[] = apply_filters( 'listify_get_card_listing_class_columns', $cols, $listing );
